  ...
  return (
    <>
      ...
      >
        ...
        <a href="https://twitter.com/solardealsindia" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="hover:scale-110 transition-all duration-300 group">
          <Twitter className="h-6 w-6 text-gray-600 group-hover:text-[#37b1e2] transition-colors" />
        </a>
